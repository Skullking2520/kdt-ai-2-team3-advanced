  ...
  return (
    <div className="px-4 sm:px-6 py-8 max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-white/80">의심 URL의 도메인 나이·SSL·리다이렉션·유사 도메인 탐지</p>
      </div>
      ...
      <AnimatePresence>
        {error && (
          <ErrorState
            type={errorType}
            title={errorType === "unknown" ? "URL 분석에 실패했어요" : undefined}
            ...
            <div className={`rounded-2xl border p-4 ${rs.bg} ${rs.border}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-white/80 mt-0.5">위험도 점수: {result.riskScore}/10</p>
                </div>
