    ...
    <div className="px-4 sm:px-6 py-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2">
          <div className="bg-[#111c30] border border-white/10 rounded-2xl p-4 relative overflow-hidden">
            ...
            <svg
              viewBox="60 80 240 310"
              className="w-full max-h-[500px] relative z-10"
            >
              {/* Sea background */}
              <rect
                x="60"
              ...
              {REGIONS.map((r) => {
                ...
                const col =
                  filter === "all"
                    ? getHeatColor(r.reports)
                    : filter === "high"
                      ? `hsl(${(1 - r.highPct / 40) * 120},80%,55%)`
                      : r.trend > 10
                        ? "#ef4444"
                        : r.trend > 0
                          ? "#f97316"
              ...
              {[
                ...
                >
                  <span
                    ...
                    style={{ backgroundColor: l.color, opacity: 0.7 }}
                  />
                  {l.label}
                </span>
              ))}
        ...
        <div className="space-y-4">
          ...
          <AnimatePresence>
            {displayed ? (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      borderColor: displayed.color + "40",
                      backgroundColor: displayed.color + "20",
                    }}
                  >
                ...
                <div className="space-y-2.5">
                  {[
                    {
                      label: "총 신고",
                      value: `${displayed.reports.toLocaleString()}건`,
                    },
                    { label: "HIGH 비율", value: `${displayed.highPct}%` },
                    { label: "주요 유형", value: displayed.topType },
                    {
                      label: "전월 대비",
                      value: `${displayed.trend > 0 ? "+" : ""}${displayed.trend}%`,
                    },
                  ].map((s) => (
                    <div
                      key={s.label}
                ...
                <div className="mt-3 h-1.5 rounded-full bg-white/8 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(displayed.reports / MAX_REPORTS) * 100}%`,
              ...
              <motion.div
                key="empty"
                className="bg-[#111c30] border border-white/8 border-dashed rounded-xl p-4 text-center"
              >
          ...
          <div className="bg-[#111c30] border border-white/10 rounded-xl p-4">
            <p className="text-xs text-white/40 mb-3 flex items-center gap-1">
              <TrendingUp size={10} /> 월별 전국 신고 추이
            </p>
              ...
              {MONTHLY.map((m) => (
                <div key={m.month} className="flex items-center gap-2">
                  ...
                  <div className="flex-1 h-2 rounded-full bg-white/5 overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${(m.total / maxMonthly) * 100}%` }}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5">
        {[
          {
            label: "전국 총 신고",
            value: `${REGIONS.reduce((s, r) => s + r.reports, 0).toLocaleString()}건`,
          },
          ...
          <div
            key={s.label}
            className="bg-[#111c30] border border-white/10 rounded-xl p-3"
          >
