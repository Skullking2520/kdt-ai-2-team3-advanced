...
- **발표 일정**: 6/17 (학원 발표) — 발표 전 PR은 안정성 우선, 새 기능 추가는 발표 후

## 코드 변경 규칙

### 1. PR 설명은 8섹션 템플릿 사용
- 자세한 형식: [docs/PR_TEMPLATE.md](docs/PR_TEMPLATE.md) 참조
...
```
/Users/aku/Downloads/심화 프로젝트 웹사이트/
...
- [docs/PR_TEMPLATE.md](docs/PR_TEMPLATE.md) — PR 설명 8섹션 템플릿
- [docs/AI_MODEL_METRICS.md](docs/AI_MODEL_METRICS.md) — F1/Precision/Recall 발표자료 (95.51% / 94.59% / 96.45%)
